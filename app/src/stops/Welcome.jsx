    ...
    <div className="max-w-3xl mx-auto text-center">
      <div className="grid grid-cols-2 gap-4 text-left max-w-xl mx-auto">
        ...
        <div className="p-3 rounded-lg bg-yellow-950/20 border border-yellow-800/30">
          <h4 className="text-sm font-semibold text-yellow-400 mb-1">RAG</h4>
          <p className="text-xs text-slate-400">Give the model knowledge at inference time via retrieval.</p>
        </div>
        <div className="p-3 rounded-lg bg-slate-800 border border-slate-600/30">
          <h4 className="text-sm font-semibold text-slate-200 mb-1">Post Training</h4>
        ...
        <div className="p-3 rounded-lg bg-cyan-950/20 border border-cyan-800/30">
          <h4 className="text-sm font-semibold text-cyan-400 mb-1">All the Options</h4>
