    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="p-5 rounded-lg bg-slate-800/30 border border-slate-700/50">
        ...
        <p className="text-sm text-slate-300 leading-relaxed mb-3">
          A context window is the total amount of text a model can "see" at once &mdash;
          your system prompt, the conversation history, any injected documents (like RAG results),
          and the model's own response, all concatenated into a single sequence of tokens.
        </p>
        ...
        <div className="mt-3 grid grid-cols-3 gap-2 text-xs text-slate-400">
          <div className="p-2 rounded bg-slate-900/30">
            <span className="font-semibold text-slate-300">SmolLM2-360M</span><br />
            2,048 tokens
          </div>
          <div className="p-2 rounded bg-slate-900/30">
            <span className="font-semibold text-slate-300">GPT-4o / Claude</span><br />
            128K&ndash;200K tokens
          </div>
          <div className="p-2 rounded bg-slate-900/30">
            <span className="font-semibold text-slate-300">Gemini 1.5 Pro</span><br />
            1M+ tokens
          </div>
        </div>
      </div>
      ...
      <div className="p-5 rounded-lg bg-slate-800/30 border border-slate-700/50">
        ...
        <div className="space-y-3">
          <div className="flex gap-3 items-start">
            <span className="text-xs font-mono text-purple-400 w-28 shrink-0 pt-0.5">System prompt</span>
          ...
          <div className="flex gap-3 items-start">
            <span className="text-xs font-mono text-yellow-400 w-28 shrink-0 pt-0.5">RAG injection</span>
            <p className="text-xs text-slate-400">
              Retrieved documents are inserted before the user's query. The more documents
              you retrieve (higher top-K), the more tokens consumed. A typical RAG setup
              might inject 500&ndash;2,000 tokens of context per query.
            </p>
          </div>
          <div className="flex gap-3 items-start">
            <span className="text-xs font-mono text-blue-400 w-28 shrink-0 pt-0.5">Conversation</span>
            <p className="text-xs text-slate-400">
              Every prior message &mdash; user and assistant &mdash; stays in the window.
              This is what gives the model "memory" within a session. But it grows
              with every exchange, eventually crowding out everything else.
            </p>
          </div>
          <div className="flex gap-3 items-start">
            ...
            <p className="text-xs text-slate-400">
              ...
              100&ndash;300 tokens. Three examples = 300&ndash;900 tokens consumed before
              the model even sees the real query.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-5 rounded-lg bg-red-950/20 border border-red-800/30">
        ...
        <p className="text-sm text-slate-300 leading-relaxed mb-3">
          Intuitively, more context should help. In practice, it often hurts.
          As the context window fills up, models exhibit several failure modes:
        </p>
        <div className="space-y-3">
          <div className="p-3 rounded bg-slate-800/50">
            ...
            <p className="text-xs text-slate-400">
              ...
              disproportionately ignored. If your most relevant RAG document lands in the
              middle of 10 retrieved passages, the model may miss it entirely.
            </p>
          </div>
          <div className="p-3 rounded bg-slate-800/50">
          ...
          <div className="p-3 rounded bg-slate-800/50">
            ...
            <p className="text-xs text-slate-400">
              ...
              three messages ago, both the wrong and right answers are in the window. The model
              must figure out which is current &mdash; and it doesn't always get it right.
              RAG can make this worse by retrieving documents that contradict each other.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-5 rounded-lg bg-slate-800/30 border border-slate-700/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="p-3 rounded bg-slate-800/50 border border-slate-700/30">
            ...
            <p className="text-xs text-slate-400">
              Drop the oldest messages when the window fills up. Simple but lossy &mdash;
              the model forgets early instructions and context. Works for casual chat,
              dangerous for multi-step tasks.
            </p>
          </div>
          <div className="p-3 rounded bg-slate-800/50 border border-slate-700/30">
            <h4 className="text-xs font-semibold text-purple-300 uppercase tracking-wide mb-2">
            ...
            <p className="text-xs text-slate-400">
              ...
              discarding them. Preserves key facts in fewer tokens. But summaries are lossy
              too &mdash; the model decides what's "important," and it may be wrong.
            </p>
          </div>
          <div className="p-3 rounded bg-slate-800/50 border border-slate-700/30">
            <h4 className="text-xs font-semibold text-purple-300 uppercase tracking-wide mb-2">
            ...
            <p className="text-xs text-slate-400">
              Maintain a separate structured store (key-value pairs, task state, user
              preferences) that gets injected into the system prompt each turn. Only the
              current state is in the window &mdash; not the full history of how it got there.
            </p>
          </div>
          <div className="p-3 rounded bg-slate-800/50 border border-slate-700/30">
            <h4 className="text-xs font-semibold text-purple-300 uppercase tracking-wide mb-2">
            ...
            <p className="text-xs text-slate-400">
              Instead of keeping everything in the window, store knowledge externally and
              retrieve only what's needed per query. This is one of RAG's underappreciated
              benefits: it lets you keep the window lean while still having access to a
      ...
      <div className="p-4 rounded-lg bg-gradient-to-r from-purple-950/30 to-slate-800 border border-purple-800/30">
        ...
        <p className="text-sm text-slate-300 leading-relaxed mb-2">
          ...
          model's limitations. Post-training attacks the problem from the other direction:
          if the model <em>already knows</em> your domain, you need less context to get a good answer.
        </p>
