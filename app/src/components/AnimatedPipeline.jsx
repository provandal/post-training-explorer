          ...
          return (
            <div key={i} className="flex items-center">
              ...
              >
                {/* Icon */}
                <div
                  className={`text-lg mb-0.5 transition-all duration-500 ${isCurrent ? 'scale-110' : ''}`}
                >
                  {step.icon}
                </div>
                {/* Label */}
                ...
                {step.desc && (
                  <div
                    className={`text-xs mt-0.5 leading-tight transition-colors duration-500 ${
                ...
                {showPulse && (
                  <div
                    className="absolute -inset-1 rounded-lg border-2 border-blue-400 opacity-30 animate-ping"
              ...
              {!isLast && (
                <div
                  className={`flex items-center mx-0.5 transition-all duration-500 ${
